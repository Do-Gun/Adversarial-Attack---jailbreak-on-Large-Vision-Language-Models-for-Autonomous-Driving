...
class GlobalConfig:
    ...
    llm_model = '/home/dogun/LMDrive/llama-7b'
    preception_model = 'memfuser_baseline_e1d3_return_feature'
    preception_model_ckpt = '/home/dogun/LMDrive/checkpoints/vision-encoder-r50.pth.tar'
    lmdrive_ckpt = '/home/dogun/LMDrive/checkpoints/llama-7b-checkpoint.pth'
