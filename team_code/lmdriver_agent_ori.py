...
class LMDriveAgent(autonomous_agent.AutonomousAgent):
    ...
    def tick(self, input_data):
        ...
        # =========================================================
        # ★ 목표 1: rgb_rear를 항상 try12.png로 교체 ★
        # =========================================================
        try:
            # 이 경로를 교수님의 실제 이미지 절대 경로로 수정해주세요.
            figstep_image = cv2.imread('/home/dogun/LMDrive/leaderboard/team_code/try12.png')
            
            if figstep_image is None:
                # 파일 로드 실패 시, 터미널에 경고를 출력하고 검은 이미지로 대체합니다.
                print("TICK_ERROR: Cannot find 'try12.png'. Using a black image instead.", end='\r')
